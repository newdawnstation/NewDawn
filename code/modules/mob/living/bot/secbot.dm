...
/mob/living/bot/secbot/GetInteractTitle()
	. = "<meta charset='UTF-8'><head><title>Securitron controls</title></head>"
	. += "<b>Automatic Security Unit</b>"

/mob/living/bot/secbot/GetInteractPanel()
	. = "<meta charset='UTF-8'>Check for weapon authorization: <a href='?src=\ref[src];command=idcheck'>[idcheck ? "Yes" : "No"]</a>"
...
/mob/living/bot/secbot/GetInteractMaintenance()
	. = "<meta charset='UTF-8'>Threat identifier status: "
	switch(emagged)
		if(0)
