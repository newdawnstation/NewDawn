var/list/department_radio_keys = list(
	  ...
	  ":c" = "Командный",	".c" = "Командный",
	  ":n" = "Научный",		".n" = "Научный",
	  ":m" = "Медицинский",	".m" = "Медицинский",
	  ":e" = "Инженерный", ".e" = "Инженерный",
	  ":s" = "Сб",	".s" = "Сб",
	  ":w" = "whisper",		".w" = "whisper",
	  ":t" = "Наёмники",	".t" = "Наёмники",
	  ":x" = "Рэйдер",		".x" = "Рэйдер",
	  ":u" = "Снабжение",		".u" = "Снабжение",
	  ":v" = "Сервис",		".v" = "Сервис",
	  ":p" = "ИИ Приватный",	".p" = "ИИ Приватный",
	  ":z" = "Развлекательный",".z" = "Развлекательный",
	  ":y" = "Экспедиция",		".y" = "Экспедиция",
	  ":k" = "Разведка",		".k" = "Разведка",	//Skrell Recon ship
	  ":o" = "Команда Реагирования",".o" = "Команда Реагирования", //ERT
	  ...
	  ":Z" = "Развлекательный",".Z" = "Развлекательный",
	  ":Y" = "Экспедиция",		".Y" = "Экспедиция",
	  ":O" = "Команда Реагирования", ".O" = "Команда Реагирования",

	  //kinda localization -- rastaf0
	  //same keys as above, but on russian keyboard layout. This file uses cp1251 as encoding.
	  ":п" = "right ear",	  ".п" = "right ear",
	  ":л" = "left ear",	  ".л" = "left ear",
	  ":о" = "intercom",	  ".о" = "intercom",
	  ":д" = "department",	  ".д" = "department",
	  ":к" = "Командный",	  ".к" = "Командный",
	  ":у" = "Научный",		  ".у" = "Научный",
	  ":м" = "Медицинский",   ".м" = "Медицинский",
	  ":и" = "Инженерный",	  ".и" = "Инженерный",
	  ":б" = "Сб",	 		  ".б" = "Сб",
	  ":ш" = "whisper",		  ".ш" = "whisper",
	  ":н" = "Наёмники",	  ".н" = "Наёмники",
	  ":й" = "Рэйдер",		  ".й" = "Рэйдер",
	  ":т" = "Снабжение",		  	 ".т" = "Снабжение",
	  ":с" = "Сервис",		  		 ".с" = "Сервис",
	  ":в" = "ИИ Приватный",	  	 ".в" = "ИИ Приватный",
	  ":э" = "Развлекательный", 	 ".э" = "Развлекательный",
	  ":ь" = "Экспедиция",			 ".ь" = "Экспедиция",
	  ":з" = "Разведка",			 ".з" = "Разведка",	//Skrell Recon ship
	  ":е" = "Команда Реагирования", ".е" = "Команда Реагирования",
)
...
/mob/living/proc/handle_speech_problems(var/list/message_data)
	...
	if((MUTATION_HULK in mutations) && health >= 25 && length(message))
		...
		verb = pick("орёт","ревёт","вопит")
		message_data[3] = 0
		. = 1
	else if(slurring)
		message = slur(message)
		verb = pick("мямлит","заливает")
		. = 1
	else if(stuttering)
		message = NewStutter(message)
		verb = pick("бормочет","заикается")
		. = 1
